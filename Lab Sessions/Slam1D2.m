...
rv = (0.5*0.5)^2; % velocity measurement noise, change to see effect
pn = (0.8)^2; % process noise
...
R = diag([rv*ones(1,1) r*ones(1,10)]); 
...
for k = 1:NumberTimeStamps-1
    ...
    % Observation
    N = [ sqrt(rv)*randn(1,1); sqrt(r)*randn(10,1)];
